...
public class PacketHandler
{
    ...
    public static void init()
    {
        playChannel = FrameworkAPI.createNetworkBuilder(new ResourceLocation(Reference.MOD_ID, "play"), 1)
                ...
                //.registerPlayMessage(C2SMessageSpawnArmorStand.class, MessageDirection.PLAY_SERVER_BOUND)
                //.registerPlayMessage(C2SMessageBeam.class, MessageDirection.PLAY_SERVER_BOUND)
                //.registerPlayMessage(S2CMessageWaterImpact.class, MessageDirection.PLAY_CLIENT_BOUND)

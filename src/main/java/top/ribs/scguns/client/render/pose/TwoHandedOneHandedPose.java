...
public class TwoHandedOneHandedPose extends WeaponPose
    {
        @Override
        protected AimPose getUpPose() {
            ...
            upPose.getIdle().setRenderYawOffset(45F).setItemRotation(new Vector3f(60F, 0F, 10F))
                    ...
                    .setLeftArm(new LimbPose().setRotationAngleX(-150F).setRotationAngleY(-30F).setRotationAngleZ(-10F).setRotationPointY(4).setRotationPointZ(-2));  // Adjusted positions
            upPose.getAiming().setRenderYawOffset(45F).setItemRotation(new Vector3f(40F, 0F, 30F)).setItemTranslate(new Vector3f(-1, 0, 0))
                    ...
                    .setLeftArm(new LimbPose().setRotationAngleX(-160F).setRotationAngleY(-30F).setRotationAngleZ(-20F).setRotationPointY(3).setRotationPointZ(-2));  // Adjusted positions
            return upPose;
        }
        ...
        protected AimPose getForwardPose() {
            ...
            forwardPose.getIdle().setRenderYawOffset(45F).setItemRotation(new Vector3f(30F, -11F, 0F))
                    .setRightArm(new LimbPose().setRotationAngleX(-60F).setRotationAngleY(-55F).setRotationAngleZ(0F).setRotationPointX(-5).setRotationPointY(2).setRotationPointZ(1))
                    .setLeftArm(new LimbPose().setRotationAngleX(-85F).setRotationAngleY(-15F).setRotationAngleZ(0F).setRotationPointY(3).setRotationPointZ(-1));  // Adjusted positions
            forwardPose.getAiming().setRenderYawOffset(45F).setItemRotation(new Vector3f(5F, -21F, 0F))
                    .setRightArm(new LimbPose().setRotationAngleX(-85F).setRotationAngleY(-65F).setRotationAngleZ(0F).setRotationPointX(-5).setRotationPointY(2))
                    .setLeftArm(new LimbPose().setRotationAngleX(-100F).setRotationAngleY(-15F).setRotationAngleZ(0F).setRotationPointY(2).setRotationPointZ(0));  // Adjusted positions
            return forwardPose;
        }
        ...
        protected AimPose getDownPose() {
            ...
            downPose.getIdle().setRenderYawOffset(45F).setItemRotation(new Vector3f(-15F, -5F, 0F)).setItemTranslate(new Vector3f(0, -0.5F, 0.5F))
                    ...
                    .setLeftArm(new LimbPose().setRotationAngleX(-35F).setRotationAngleY(-20F).setRotationAngleZ(15F).setRotationPointY(4).setRotationPointZ(0));  // Adjusted positions
            downPose.getAiming().setRenderYawOffset(45F).setItemRotation(new Vector3f(-20F, -5F, -10F)).setItemTranslate(new Vector3f(0, -0.5F, 1F))
                    ...
                    .setLeftArm(new LimbPose().setRotationAngleX(-40F).setRotationAngleY(-20F).setRotationAngleZ(20F).setRotationPointY(4).setRotationPointZ(0));  // Adjusted positions
            return downPose;
        }
        ...
        public void renderFirstPersonArms(Player player, HumanoidArm hand, ItemStack stack, PoseStack poseStack, MultiBufferSource buffer, int light, float partialTicks)
        {
            ...
            poseStack.pushPose();
            {
                ...
                poseStack.translate(-0.3125 * side, -0.15, -1);

...
public class    ModEffects
{
    ...
    public static final RegistryObject<SulfurPoisoningEffect> SULFUR_POISONING = REGISTER.register("sulfur_poisoning", () -> new SulfurPoisoningEffect(MobEffectCategory.HARMFUL, 0xFFE135));
    public static final RegistryObject<LaceratedEffect> LACERATED = REGISTER.register("lacerated", () -> new LaceratedEffect(MobEffectCategory.HARMFUL, 0));
}

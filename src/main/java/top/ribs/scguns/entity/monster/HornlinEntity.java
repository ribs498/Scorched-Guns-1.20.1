...
public class HornlinEntity extends Monster implements RangedAttackMob {
    ...
    private static boolean isGoldItem(ItemStack stack) {
        return isPoisonItem(stack) || // Include poison items so they get targeted
    ...
    public void registerGoals() {
        this.goalSelector.addGoal(1, new GoldSeekingGoal(this, 1.0, 8.0F)); // High priority gold seeking
        ...
        this.goalSelector.addGoal(4, new WaterAvoidingRandomStrollGoal(this, 1.0)); // Simple stroll goal
        this.goalSelector.addGoal(5, new LookAtPlayerGoal(this, Player.class, 8.0F));
        this.goalSelector.addGoal(6, new RandomLookAroundGoal(this));

        // Updated targeting goals to be more aggressive like piglin brutes

...
public class LightningProjectileEntity extends ProjectileEntity {
    ...
    private static final double BOUNCE_RANGE = 10.0; // Adjust this value for the bounce range
    private int bouncesLeft;
    private float currentDamage;
    private static final long BOUNCE_DELAY_TICKS = 4; // 200 ms / 50 ms per tick
